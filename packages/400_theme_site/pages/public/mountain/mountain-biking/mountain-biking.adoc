...
tagline:                                Trails Are Open For The Season
...
image:
  path:                                 /assets/image/module/attic/1920x1280/MBTopen.jpg
  width:                                1920
  height:                               1280
...
resources:                              [ animate, gallery, lightbox3,
...
resource_options:
  ...
  - attic:
      slides:
        - url:                          /assets/image/module/attic/1920x1280/MBTopen.jpg
...
{% include custom/trail-status.html variant="widget-mtb" %}
++++
