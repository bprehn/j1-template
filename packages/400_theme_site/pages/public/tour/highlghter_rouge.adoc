...
description: >
                                        ...
                                        integrated with MK development site. The highlighter supports 100+
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
[role="dropcap"]
*Rouge* is a code highlighter built into the MK development site. *Code highlighting*
...
The MK development site uses two default Rouge themes -- one for *light mode*
...
To preview *all* themes supported by *MK development site*, click the button
...
The MK development site also comes with its own *site search*. Site search lets
...
The MK development site builds a search index for your whole site automatically,
