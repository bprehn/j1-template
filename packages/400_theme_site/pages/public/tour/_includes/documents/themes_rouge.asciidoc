...
For the default themes `Uno` of MK development site, the following _Rouge_ themes
are used:

* theme_light: based on theme `igorpro`
* theme_dark:  based on theme `monokai.sublime`

The *default* themes used for the MK development site can be configured with
...
To preview *all* themes supported by *MK development site*, make your selection
